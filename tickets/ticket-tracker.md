...
Last refreshed: 2026-07-16 (RT-003 done)
...
1. **Iana** — finish **RT-009** (define `Hittable` / `HitRecord` early so Sofia can plug objects in).
2. **Sofia** — **RT-004** sphere, then **RT-005–007**.
